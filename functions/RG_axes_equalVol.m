function RG_axes_equalVol(varargin)

error(['mrGrad v2.0: The function RG_axes_equalVol() is no longer supported.', newline, ...
       'Please use mrgrad_axes_equivolume() instead.']);
% 
% %--------------------------------------------------------------------------
